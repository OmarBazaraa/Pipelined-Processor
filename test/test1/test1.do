...
force -freeze sim:/processor/PC_Reset_Din 0000000100 0
...
run
run
force -freeze sim:/processor/PORT_IN 0000000000000101 0
run
run
force -freeze sim:/processor/PORT_IN 0000000000000100 0
run
force -freeze sim:/processor/PORT_IN 0000000000000111 0
run
run
force -freeze sim:/processor/PORT_IN 0000000000000000 0
run
run
run
run
